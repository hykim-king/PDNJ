		...
		<div>
			<form action="#" name="userRegFrm">
				<div class="p-div">
					...
					<input type="text" class="p-input ppl_input" readonly="readonly" name="userId" id="userId" placeholder="아이디를 입력하세요." 
					       value="${outVO.userId}" size="20" maxlength="30">
				</div>
				<div class="p-div">
					<label for="password" class="p-label">비밀번호</label> 
					<input type="password" class="p-input" name="password" id="password" placeholder="비밀번호를 입력하세요." 
					       value="${outVO.password}" size="20" maxlength="30">
				</div>
				<div class="p-div">
					<label for="username" class="p-label">이름</label> 
					<input type="text" class="p-input" name="username" id="username" placeholder="이름을 입력하세요." 
					       value="${outVO.username}" size="20" maxlength="21">
				</div>
				<div class="p-div">
					<label for="email" class="p-label">이메일</label> 
					<input type="text" class="p-input" name="email" id="email" placeholder="이메일을 입력하세요." 
					       value="${outVO.email}" size="20" maxlength="320">
				</div>
				<div class="p-div">
                    <label for="userTel" class="p-label">전화번호</label> 
                    <input type="text" class="p-input" name="userTel" id="userTel" placeholder="전화번호를 입력하세요." 
                           value="${outVO.userTel}" size="20" maxlength="20">
                </div>
			</form>
		</div>
		<!-- // 회원 등록 영역 ----------------------------------------------------->
